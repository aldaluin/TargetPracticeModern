...
namespace Goldraven.AI {
	...
	public class ActWander : ActBase {
		...
		public ActWander(AIBase ai, Transform loc, AIFactory aifac) : base (ai, loc) {
			// constructor
			aifactory = aifac;
		}
		...
		public  override void continueAction(){
			// never finished; never successful; just wanders until interrupted
